...
#   Mayor.create(name: 'Emanuel', city: cities.first)
 ...
 School.create([{name: 'Alok', address: 'hiram mangri sec-6', phone_no: '9876543210', city: 'Udaipur', state: 'Rajasthan', zipcode: '313001'}])
 Classroom.create([{name: 'First', number_of_students: '20', school_id: '1'}, 
	{name: 'Second', number_of_students: '20', school_id: '1'},
	{name: 'six', number_of_students: '20', school_id: '1'}])
